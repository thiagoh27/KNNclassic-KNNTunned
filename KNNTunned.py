...
bandwidth = 10  # Você pode alterar este valor
...
# Calcular a média de acurácia para cada classificador
accuracy_table['Mean Accuracy'] = accuracy_table.mean(axis=1)

# Ordenar os classificadores pela média de acurácia
accuracy_table = accuracy_table.sort_values(by='Mean Accuracy', ascending=False)
